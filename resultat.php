...
<?php
    ...
    if ($match != '' && (time() - filemtime($match) < 60)) {
        ...
        $url = "http://api-adresse.data.gouv.fr/search/?q=" . $motRecherche . "&rpp=10&include_entities=true&result_type=recent&lang=fr&locale=fr";
    ...
    //         echo "<u>" . $msg->coordinates ."</u> : ". $msg->text;
    //         echo "<br />";
    //     }
    // }
    // else 
